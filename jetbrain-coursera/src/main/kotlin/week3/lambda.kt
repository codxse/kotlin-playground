val mapper = { x: Int, y: Int -> x * y }
val cordinate = listOf(Pair(1,2), Pair(2,2), Pair(3,2))



fun main() {
    val dots = cordinate.map { it.first * it.second }
    println(dots);
}

// Interchangeable predicates
// ====================================
// Functions 'all', 'none' and 'any' are interchangeable,
// you can use one or the other to implement the same functionality.
